  ...
  return (
    <div className="container mx-auto px-6 py-24 bg-gradient-to-br from-champagne-50 via-champagne-100 to-champagne-50">
      ...
      <div className="flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="md:w-1/2">
          <h2 className="text-3xl font-semibold mb-8 text-plum-800 font-playfair">Dolapo Udekwe</h2>
          <div className="space-y-6 text-lg text-charcoal-700 leading-relaxed">
            <p>
              Welcome to my world of beauty and artistry. I&apos;m Dolapo Udekwe, a passionate and professional makeup artist with over a decade of experience in the beauty industry. My journey began in 2013, fueled by a deep love for creativity and a desire to help individuals feel confident in their own skin.
            </p>
            <p>
