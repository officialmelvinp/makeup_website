    ...
    <div className="container mx-auto px-6 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
        ...
        <div>
          <h2 className="text-3xl font-semibold mb-6 text-plum-700 font-playfair">
            Elevate Your Beauty with DazzleDolls
          </h2>
          <p className="text-lg text-charcoal-600 mb-6 font-lato">
            At DazzleDolls, we believe that makeup is more than just enhancing your appearance—it's about boosting your
            confidence and helping you feel your absolute best. Our team of skilled makeup artists is dedicated to
            creating stunning looks that reflect your unique personality and style.
          </p>
          <p className="text-lg text-charcoal-600 font-lato">
            Whether you're preparing for your wedding day, a special event, or a professional photoshoot, we're here to
            ensure you look and feel amazing. Our commitment to excellence, attention to detail, and passion for beauty
            set us apart in the world of makeup artistry.
          </p>
        </div>
      </div>
      ...
      <div className="mt-16 bg-champagne-100 p-8 rounded-lg shadow-lg">
        ...
        <p className="text-lg text-charcoal-600 mb-4 font-lato">
          When you choose DazzleDolls, you're not just getting a makeup service—you're getting a partner in your beauty
